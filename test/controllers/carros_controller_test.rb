...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post carros_url, params: { carro: { clave_car: @carro.clave_car, marca_car: @carro.marca_car, matricula: @carro.matricula, modelo_car: @carro.modelo_car, reprobo: @carro.reprobo } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { clave_car: @carro.clave_car, marca_car: @carro.marca_car, matricula: @carro.matricula, modelo_car: @carro.modelo_car, reprobo: @carro.reprobo } }
